      ...
      <div class="keepPX-middle_login">
        ...
        <el-form :model="ruleForm" status-icon ref="ruleForm" class="demo-ruleForm">
          <el-form-item prop="username">
            <el-input placeholder="用户名" type="text" v-model="ruleForm.username" autocomplete="off"
                      prefix-icon="iconfont icon-zhanghao"></el-input>
          </el-form-item>
          ...
          <el-form-item prop="captcha">
            <div class="keepPX-imgbox">
              <el-input type="text" v-model="ruleForm.captcha" autocomplete="off"
                        prefix-icon="iconfont icon-checkcode"></el-input>
